...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\scriptsize \textit{ \footnotesize{\newline{}\textbf{Courses:} Data Structures, Linear Algebra, Algorithms (In Progress), Software Development (In Progress)}}}
    \resumeSubheading
    ...
    \resumeSubheading
      {\href{https://schs.svvsd.org}{Silver Creek High School}}{Longmont, Colorado}
      {High School Diploma;  GPA: 4.000}{August, 2018 - May, 2022}
      {\scriptsize \textit{ \footnotesize{\newline{}\textbf{Courses:} Calculus I, Calculus II, AP Computer Science A}}}
...
\section{Experience}
  ...
  \resumeSubheading{University of Colorado Boulder}{Boulder, CO}
    {MATH 1300: Calculus I Learning Assistant}{January, 2023 - Present}
    ...
    {Cybersecurity Student Designer}{August, 2019 - July, 2022}
    ...
    \begin{itemize}
        ...
        \item Regularly presented to district and community leaders during board meetings and Innovation Center tours.
    \end{itemize}
\vspace{-5pt}
    \resumeSubheading
...
\vspace{-5pt}
\item {Colorado School of Mines Medal of Achievement in Mathematics and Science - \textit{May, 2021}}
\end{description}

\section{Scholastic Extracurricular Activities}
\begin{description}[font=$\bullet$]
\item Competitive Programming Participant \hfill \textit{Silver Creek High School}
\vspace{-5pt}
\item CyberPatriot Platinum Tier Competitor \hfill \textit{Silver Creek High School}
\vspace{-5pt}
\item Acting Student Body Vice President \hfill \textit{Silver Creek High School}
\vspace{-5pt}
\item Violinist Section Leader \hfill \textit{Silver Creek High School}
\vspace{-5pt}
\end{description}
