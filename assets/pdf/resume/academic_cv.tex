...
\section{~~Education}
  \resumeSubHeadingListStart
    ...
    \begin{itemize}[label=-]
      \vspace{-5pt}
      \item Seeking to understand liquidity provisioning in prediction markets and decentralized exchanges from a contract design perspective.
      \vspace{-5pt}
      \item Thinking about liquidity provisioning as multiple automated market makers running in parallel. 
      \vspace{-5pt}
    ...
    \begin{itemize}
      ...
      \item Talks
      \begin{enumerate}
        \item \bibentry{bhaskara2023generalecdefitalk}
      \end{enumerate}
    \end{itemize}
    ...
    \vspace{-5pt}
    \item Semi-technical blog at \href{https://officialadithya.github.io/blog/}{https://officialadithya.github.io/blog/}
    \vspace{-5pt}
    \end{description}
