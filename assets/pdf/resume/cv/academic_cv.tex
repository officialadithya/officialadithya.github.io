...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \\
      {\scriptsize \textit{\footnotesize{\newline{}\textbf{Major GPA:} 4.000, \textbf{Cumulative GPA:} 3.992 (as of Dec. 2025) \href{https://officialadithya.github.io/assets/pdf/resume/unofficial_transcript.pdf}{Transcript}.}}}
      \\
      \vspace{3pt}
      ...
      \vspace{-20pt}
      {\scriptsize \textit{\footnotesize{\newline{}\textbf{Relevant Coursework:} 8 Graduate Courses Including Linear and Integer Programming, Algebra 1, Theory of Computation, Design and Analysis of Algorithms, Advanced Algorithms, Algorithmic Economics, Advanced Convex Optimization, Measure-Theoretic Probability, Complexity Theory (Audit)}}}
            % \resumeSubheading
    ...
    Research interests include topics in (broadly) theoretical computer science, especially computational social choice theory, algorithmic economics, matrix multiplication, and (fine-grained) complexity theory.
    \\
    \emph{Advised by \href{https://sites.google.com/mit.edu/bailey-flanigan/home}{Bailey Flanigan, Ph. D.}}\hfill{\textit{August, 2025 - Present}}
    \\
    \begin{itemize}[label=-]

      \item \href{https://officialadithya.github.io/assets/pdf/talks/ugrad_thesis_proposal.pdf}{Proposal Defense Slides}. November 7, 2025.
      \vspace{-5pt}
  ...
  % \end{itemize}
  \item Honorable Mention for the \href{https://cra.org/crae/awards/cra-outstanding-undergraduate-researchers/}{Computing Research Association (CRA)'s Outstanding Undergraduate Researcher Award} \\ \hfill \textit{December, 2025}
  \vspace{-5pt}
  ...
  \section{Scholarly Service \& Additional Research Activity}
    ...
    \vspace{-5pt}
    \item Engineering Honors Program First-Year Seminar Recitation Leader \hfill \textit{University of Colorado Boulder, 2024, 2025}
    \vspace{-5pt}
