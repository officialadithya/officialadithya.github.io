...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science - Computer Science; Bachelor of Arts - Mathematics}{August, 2022 - May, 2026 (Expected)}
      \\
    ...
    \begin{itemize}[label=-]
      ...
      \vspace{-5pt}
      \item Assisted Rafael Frongillo with reviewing two submissions to SODA and Management Science.
      \vspace{-5pt}
   ...
   \\
    \begin{itemize}[label=-]
      \vspace{-5pt}
      \item Seeking to develop algorithms for special cases of the \textsc{MatrixMultiplicationVerification} problem using rank-metric codes and other techniques from coding theory.
   \end{itemize} 
   \textsc{Preprints}
   \begin{enumerate}
  ...
  \textsc{Talks}
  \begin{enumerate}
    \item \bibentry{bhaskara2023generalecdefitalk}, \href{https://www.youtube.com/watch?v=JWsXMNSOygA}{Recording}.
  \end{enumerate}
